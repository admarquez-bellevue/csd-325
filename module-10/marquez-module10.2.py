...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        # Added instructions to delete tasks.
        todo1 = tk.Label(self.tasks_frame, text="--- Add Items --- \n** Right Click To Delete **", bg=color1,
            fg="white", pady=10)
        ...
        self.colour_schemes = [{"bg": color1, "fg": "white"}, {"bg": color2, "fg": "black"}]
